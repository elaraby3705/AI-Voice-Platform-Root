    ...
    <div className="min-h-screen bg-[#020202] text-slate-300 font-sans p-6 lg:p-12">
        <main className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {[
                    { title: "Active Projects", val: projects.length, icon: Zap },
                     ...
                     <div className="h-[250px] w-full">
                        <ResponsiveContainer>
                            <AreaChart data={[{v:10}, {v:35}, {v:25}, {v:60}]}>
                                ...
                                <defs><linearGradient id="grad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#4f46e5" stopOpacity={0.2}/><stop offset="100%" stopColor="#4f46e5" stopOpacity={0}/></linearGradient></defs>
                            </AreaChart>
                        </ResponsiveContainer>
                     </div>
                </div>
